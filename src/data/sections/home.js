export const homeContent = {
  ...
  contacts: [
    ...
    { icon: 'github', label: 'GitHub', href: 'https://github.com/thesakshimane' },
    { icon: 'linkedin', label: 'LinkedIn', href: 'https://linkedin.com/in/thesakshimane' },
    { icon: 'medium', label: 'Medium', href: 'https://medium.com/@manesakshi1712' },
  ],
};
